...
#define ERRFILE_golan		     ( ERRFILE_DRIVER | 0x00770000 )
#define ERRFILE_hermon_settings	     ( ERRFILE_DRIVER | 0x00780000 )
...
#define ERRFILE_boot_menu_ui	      ( ERRFILE_OTHER | 0x00470000 )
